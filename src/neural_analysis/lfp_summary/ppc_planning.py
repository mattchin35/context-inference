"""Deterministic allocation and immutable plans for grouped PPC execution."""
...
from src.neural_analysis.spike_lfp.ppc_kernel import estimate_segmented_kernel_allocation
