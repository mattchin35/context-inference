...
from src.neural_analysis.lfp_summary.power_validation import build_ct026_power_config
...
def _source_identifiers(config: LFPSummaryConfig) -> dict[str, str]:
    ...
    return {
        ...
        "validation_module": str(Path(__file__).resolve().parents[1] / "lfp_spike_phase_validation.py"),
        "session_id": config.session_id,
    }
