"""Reusable spike, behavior, raster, and PSTH plots."""
...
from src.neural_analysis.spike_behavior.psth import LickPethData, SpikePethData
...
def _draw_peth_trial_event_markers(
    ax,
...
def _format_lick_axes(
    ...
    _draw_peth_trial_event_markers(
        raster_ax,
        lick_peth_data,
